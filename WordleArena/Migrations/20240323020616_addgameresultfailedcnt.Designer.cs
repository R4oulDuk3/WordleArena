...
namespace WordleArena.Migrations
{
    ...
    [Migration("20240323020616_addgameresultfailedcnt")]
    partial class addgameresultfailedcnt
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("WordleArena.Domain.TempoPlayerResultInfo", "ResultInfo", b1 =>
                        {
                            ...
                            b1.Property<int>("FailedWords")
                                .HasColumnType("integer")
                                .HasColumnName("result_info_failed_words");
                            ...
                            b1.Property<double>("Score")
                                ...
                                .HasColumnName("result_info_score");
